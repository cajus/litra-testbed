...
export let mixin = {
    ...
    // Skipping colorTemperature levels methods
    
    async getBrightnessEffectiveMax() {
        const res = await this.sendReport(this.getFeatureIndex(0x1990), 12, new Uint8Array(0));
        return (res[0] << 8) + res[1];
    },
};